...
int main(int argc, char** argv) { // main 함수 정의
    ...
    glutCreateWindow("GL Modeling - 2D Primitive(GL_QUADS)"); // "GL Modeling - 2D Primitive(GL_QUADS)"의 타이틀로 새로운 Window(창) 생성
