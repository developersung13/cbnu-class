...
///* 7. A, S, D, W 및 키보드 우측의 방향키 입력 시 카메라의 시점과 위치를 조정할 수 있습니다.    */
///* 8. 키보드 상단의 F1키 입력 시 카메라의 시점과 위치를 초기 상태로 되돌립니다.                     */
///* 9. 메뉴 창에서 Shuffle the answer 클릭 시 터미널 창에 정답이 나타나고 이어서 문을            */
///* 선택할 시 오답이 위치한 문들 중에서 임의의 문 번호가 터미널 창에 표시됩니다.                      */
///* 10. 메뉴 창에서 “Exit” 클릭 시 프로그램이 종료됩니다.                                                        */
///*                - - - - - - -                                                                                                       */
///************************************************************************************************/
